...
class BotKindTests(unittest.TestCase):
    ...
    def test_teela_system_report_is_read_only_twin(self) -> None:
        ...
        self.assertIn("young lady", d.default_soul_for_kind("teela-brain", "Teela", "move"))
        self.assertIn("happy to be alive", d.default_soul_for_kind("teela-brain", "Teela", "move"))
        self.assertIn("young lady", d._FAST_CHAT_SYS)
        self.assertIn("young lady", d._TEELA_MINIOS_SYS)
        ...
        self.assertIn("young lady", d.agent_md_for_kind("teela-brain"))
        ...
        self.assertIn("young lady", d.migrate_teela_soul(bare))
